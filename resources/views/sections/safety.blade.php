...
{{-- ============================================ --}}
<section id="safety" class="relative py-24 lg:py-32 bg-navy-950 overflow-hidden">
    <!-- Decorative background -->
    <div class="absolute top-0 right-0 w-1/2 h-full bg-navy-900/50 -skew-x-12 translate-x-1/4"></div>
    <div class="absolute top-40 left-10 w-72 h-72 bg-gold-500/5 rounded-full blur-3xl"></div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <!-- 1. Implementasi K3 Telekomunikasi -->
            <div class="reveal group relative p-8 rounded-3xl bg-white/5 border border-white/10 hover:border-gold-500/30 transition-all duration-500">
                ...
                <h3 class="text-xl font-bold text-white mb-4">Implementasi K3 Telekomunikasi</h3>
